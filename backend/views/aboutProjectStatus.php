...
$webPage->appendHead('
 	<link rel="stylesheet" href="/assets/libs/tablesorter/2.30.4/css/theme.bootstrap_4.min.css">
');
$poolFilters = '';
$poolAttach = '';
// if ($numberOfPools > 1) {
...
$webPage->appendScript('
	<script src="/assets/libs/tablesorter/2.30.4/js/jquery.tablesorter.min.js"></script>
	<script src="/assets/libs/tablesorter/2.30.4/js/jquery.tablesorter.widgets.min.js"></script>
  	<script>
 		$(function() {
		  $("table").tablesorter({
		    theme : "bootstrap",
...
// if ($numberOfPools > 1) {
// 	$buttons .= '
// 		<div class="btn-group-toggle mb-3 ml-3" data-toggle="buttons">
// 	';
// 	for ($p = 1; $p <= $numberOfPools; $p++) {
// 		$buttons .= '
...
// 			<div class="btn-group-toggle mb-3 mr-3" data-toggle="buttons">
...
$projects = '
	<div class="table-responsive">
		<table style="padding:3px;" id="projectTable" class="table table-striped table-hover table-condensed table-bordered tablesorter">
